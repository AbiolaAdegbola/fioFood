...
session_start();
 ...
 ?>       	
      ...
      <div id="divContenantMS">
        <div class="suprimerAnnonce"><a href="http://localhost/fioFood/compteSuprimerPoste.php?suppCollection=<?php echo simple_encrypt($recuperationInfo['id']); ?>" style="color: red;" onclick="return confirm('Voulez-vous supprimer votre annonce?');" class="suprimerAnnonceCompteCollection"><i class="fa fa-trash" aria-hidden="true"></i></a></div>
      </div>
	</section>
 	        <?php }?>
            	</div>
        ...
        <div class="suprimerAnnonce"><a href="http://localhost/fioFood/compteSuprimerPoste.php?suppCollection=<?php echo simple_encrypt($recuperationInfo['id']); ?>" style="color: red;" onclick="return confirm('Voulez-vous supprimer votre annonce?');" class="suprimerAnnonceCompteCollection"><i class="fa fa-trash" aria-hidden="true"></i></a></div>
    	  ...
    	  $recuperation = $bdd->prepare('SELECT * FROM panier WHERE id_fiofood=:id LIMIT 2,1');
 	     	...
 	     	while ($recuperationInfo = $recuperation->fetch()) {
 	     		?>
  	<section class="postesMarche">
  		<div class="collectioDetailPanier" data-id="<?php echo ($recuperationInfo['id']); ?>" type="button">
		<div class="imagePosteMarche">
			<img src="<?php echo 'imagepanier/'.$recuperationInfo['imagepanier'];?>">
		</div>
		<div class="descriptionsPosteMarche">
  ...
  <!-- session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux session deux-->
...
<!-- session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois session trois-->

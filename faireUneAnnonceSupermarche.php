...
$ins = $bdd->prepare('INSERT INTO fiofoodsupermarket(id_fiofood,nomproduit,categorie,prixproduit,imageproduit,description,datepublication) VALUES(:id_fiofood,:nomproduit,:categorie,:prixproduit,:imageproduit,:description,NOW())');
    ...
    //ENREGIUSTREMENT DES INFORMATION DANS LA BASE DE DONNEES fioFoodAnnonce
$ins = $bdd->prepare('UPDATE fiofoodsupermarket SET nomproduit=:nomproduit,categorie=:categorie,prixproduit=:prixproduit,imageproduit=:imageproduit,description=:description WHERE id=:id');
  ...
  <div id="descriptionPostesConteneur">
  	...
  	<div class="uniteMesureAnnonce">
  		...
  		<select class="zoneInformation" name="categorie">
  			...
  			<option>Volaille,Poisson et Viande</option>
  			<option>Epicerie</option>
  			<option>Boissons</option>
  			<option>Liqueurs et Alcools</option>
  			<option>fruits et légumes</option>
  			<option>Surgelés</option>
  			<option>Bio et forme</option>
  			<option>Soins et hygiène</option>
  			<option>Animaux</option>
  			<option>Produits frais</option>
  			<option>Entretien</option>
  			<option>Bébé</option>
  			<option>Non-alimentaire</option>
  		</select>
  	</div><br>
  	<div class="prixAnnonce">
  ...
  <div id="descriptionPostesConteneur">
  	...
  	<div class="uniteMesureAnnonce">
  		...
  		<select class="zoneInformation" name="categorie" value="<?php echo($modifierPosteInfo['categorie']); ?>">
  			...
  			<option value="Volaille,Poisson et Viande">Volaille,Poisson et Viande</option>
  			<option value="Epicerie">Epicerie</option>
  			<option value="Boissons">Boissons</option>
  			<option value="Liqueurs et Alcools">Liqueurs et Alcools</option>
